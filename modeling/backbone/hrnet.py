...
class HRNet(Backbone):
    def __init__(self, cfg, **kwargs):
        ...
        out_stage_idx = [{"stage1": 0, "stage2": 1, "stage3": 2, "stage4": 3}[
        ...
        self._out_feature_channels = {'stage{}'.format(
            i+1): r for i, r in enumerate(pre_stage_channels)}
        self._out_feature_strides = {"stage1": 2,
                                     "stage2": 4, "stage3": 8, "stage4": 16}
