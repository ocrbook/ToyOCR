...
if __name__ == "__main__":
    ...
    cfg.merge_from_file("yamls/layout_analysis/centernet_res50_layout_analysis.yaml")

    # model
    model = build_model(cfg)
    DetectionCheckpointer(model).load("exp_results/layout_exp_R50/model_final.pth")
    model.eval()
