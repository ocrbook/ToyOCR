...
class toyOCR_ONNX():
    ...
    def inferencen_on_images(self, images, new_size=(640, 384), thresh=0.3):
        # images: [ndarray(H,W,C),...] in bgr Mode
        # only support batch = 1, rely on ToyOCR2onnx input , line: 142
        # you can modify your batch in ToyOCR2onnx and generate new model
        assert len(images) == 1
...
if __name__ == '__main__':
    ort_sess = toyOCR_ONNX('models/me.onnx')
    img = cv2.imread('textrecog.jpg')
